...
from utils import STATE4, SCADA_LOOP
...
SCADA_ADDR = SUBNET_3['scada']
RTU_ADDR = SUBNET_3['rtu']
...
class ScadaServer(SCADAServer):
    ...
    def main_loop(self):
        ...
        while(True):
            ...
            cursorObj = db.cursor()
            cursorObj.execute('SELECT name, value FROM hmi4 WHERE name="MODE"')
